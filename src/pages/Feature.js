...
import AccessAnywhere from "./page-style/icons/icon-access-anywhere.svg"
// Security icon
import Security from "./page-style/icons/icon-security.svg"
// Any File icon
import AnyFile from "./page-style/icons/icon-any-file.svg"
// collaboration icon
import Collaboration from "./page-style/icons/icon-collaboration.svg"
// css file
